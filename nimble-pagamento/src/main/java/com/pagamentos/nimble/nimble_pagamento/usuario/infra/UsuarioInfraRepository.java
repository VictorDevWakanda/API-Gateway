...
public class UsuarioInfraRepository implements UsuarioRepository {
    ...
    public Usuario salvaUsuario(Usuario novoUsuario) {
        ...
        log.debug("[Finaliza] UsuarioInfraRepository - salva");
        return novoUsuario;
    }
    ...
    public Usuario buscaUsuarioAtravesId(UUID idUsuario) {
        ...
        log.debug("[Finaliza] UsuarioInfraRepository - buscaUsuarioAtravesId");
        return usuario;
    }
    ...
    public void deletaUsuario(Usuario usuario) {
        ...
        log.debug("[Finaliza] UsuarioInfraRepository - deletaUsuario");
    }
    ...
    public Usuario buscaUsuarioPorCpf(String cpfUsuario) {
        ...
        Usuario usuario = usuarioSpringDataJPARepository
                ...
                .orElseThrow(() -> APIException.build(HttpStatus.NOT_FOUND, "Usuario não encontrado"));
        log.debug("[Finaliza] UsuarioInfraRepository - buscaUsuarioPorCpf");
        return usuario;
    }

    @Override
    public Usuario buscarUsuarioPorCpfOuEmail(String cpfOuEmail) {
        log.info("[Inicia] UsuarioInfraRepository - buscaUsuarioPorCpf");
        Usuario usuario = usuarioSpringDataJPARepository
                .findByCpf(cpfOuEmail)
